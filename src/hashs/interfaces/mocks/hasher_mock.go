...
// CheckPassword provides a mock function with given fields: password, passwordHashed
func (_m *MockHasher) CheckPassword(password string, passwordHashed string) error {
	ret := _m.Called(password, passwordHashed)
